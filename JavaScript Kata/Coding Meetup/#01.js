...
who have signed up to attend the coding meetup that you are organizing for the first time.
...
function countDevelopers(list) {
  return list.filter((item) => item.language === "JavaScript" && item.continent === "Europe").length;
}
